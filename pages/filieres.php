            ...
            <div class="panel-body">
                ...
                <form method="get" action="filieres.php" class="form-inline">
                    ...
                    <select name="niveau" class="form-control" id="niveau" onchange="this.form.submit()">
                        ...
                        <option value="2eme" <?php if ($niveau === "2eme")  echo "selected" ?>>2eme annee</option>
                            ...
                            <tr>
                                ...
                                <?php if ($_SESSION['user']['role'] == 'ADMIN') { ?>
                                    <td>
                                        ...
                                        &nbsp;
                                        <a onclick="return confirm('Etes vous sur de vouloir supprimer la filière')" href="supprimerFiliere.php?idF=<?php echo $filiere['idFiliere'] ?>">
